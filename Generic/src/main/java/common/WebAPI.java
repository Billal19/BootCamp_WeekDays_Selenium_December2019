...
public class WebAPI {
    ...
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("false") String cloudEnvName,
                      @Optional("windows") String os, @Optional("10") String os_version, @Optional("chrome-options") String browserName, @Optional("34")
                              String browserVersion, @Optional("https://www.marriott.com") String url) throws IOException {
    ...
    public static void scrollUpDown(int scroll){
        ...
        Scroll.executeAsyncScript("window.scrollBy(0,"+scroll+")");
    }

    public static void scrollToWebElement(String path){
        ((JavascriptExecutor)driver).executeAsyncScript("arguments[0].scrollIntoView();",driver.findElement(By.xpath(path)));
    }
